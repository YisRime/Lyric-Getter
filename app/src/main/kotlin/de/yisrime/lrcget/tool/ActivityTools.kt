...
import de.yisrime.lrcget.data.AppRules
import de.yisrime.lrcget.data.GithubReleaseApi
import de.yisrime.lrcget.tool.JsonTools.parseJSON
...
object ActivityTools {
    ...
    fun checkUpdate() {
        Thread {
            "https://api.github.com/repos/YisRime/Lyric-Getter/releases/latest".get(onSuccess = {
                try {
